...
export default function SeasonList() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4" onMouseDown={e => { if (e.target === e.currentTarget) setShowModal(false); }}>
